export const SuitAndTie = `Reverend, reverend, please come quick
...
export const SoManyMoons = `So many moons come and gone
...
export const SpokeAndSage = `A man sure of anything is surely right about nothing.
...
export const GraceAndJack = `Grace and Jack had quite a bond they thought everlasting, though,
It seemed as the flowers ripened, the love wilted so.
It didn't take long for Grace to move on to the next stag in the meadow,
And Jack sat there in lone despair. 'cause Grace threw Jack aside.

But he came to, 'cause if it's true there's a Jill for every Jack.
He found one fast he knew would last; they made the lifelong pact.
But not for long was the celebration; he needed something she lacked.
So Jill sat there with tear-matted hair. 'cause Jack threw Jill aside.

But Jill found herself jumping for joy 'cause she met a man so fine,
A proper-mannered, sweet boy Will, he'd stay for the rest of time.
But the clock ticked and ticked; from the wall, it dripped. till she seemed to lose her mind.
And Will cried in a room he once shared. 'cause Jill threw Will aside.

Now, there's something I've learned in life, that I feel I must confide:
Ends are sometimes funny, and they almost never rhyme.

But Will wanted that love so bad; y'know, he would've died.
and this ending just so happens to be he bit down on cyanide.`;
export const BrookInTheCity = `The farmhouse lingers, though averse to square
...
export const StoppingByWoods = `Whose woods these are I think I know.
...
King for a day.
`;
export const ACliffDwelling = `There sandy seems the golden sky
...
export const AFountainABottleADonkeysEarsAndSomeBooks = `Old Davis owned a solid mica mountain
